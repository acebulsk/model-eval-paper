...
Partitioning of snowfall by forest canopies, which occurs over 23% of the global land mass, represents an important process for predicting water resources and land-surface energy exchanges. In cold-dry continental climates, researchers estimate that over half of annual snowfall may be lost to the sublimation of intercepted snow from the canopy. In warm-humid maritime climates the majority of snowfall melts in the canopy, limiting atmospheric losses from sublimation, and contributes to changes in the phase and timing of precipitation reaching the ground. Despite the strong hydrological influence snow interception processes, sparse observations of these process have led to theories on snow interception and canopy snow ablation that have uncertain application across differing climate and forest types. Recent observations in western and northern Canada have revealed novel insights into snow interception and canopy snow ablation processes. Subcanopy throughfall and canopy structure measurements from aerial LiDAR, combined with high-frequency lysimeter measurements of canopy snow load and unloading have advanced snow interception process understanding across a broad range in canopy densities and meteorological conditions. The new parameterisation better represents enhanced interception efficiency by wind-driven horizontal snowfall and subsequent increases in canopy snow unloading due to wind, snowmelt, and sublimation. To assess the effectiveness of these new parameterisations, both novel and traditional routines were implemented in the Cold Regions Hydrological Modelling platform and evaluated against observations of subcanopy snow water equivalent and canopy snow load across four Canadian sites: two continental climate sites (Marmot Creek and Fortress Mountain, Alberta), one subarctic site (Wolf Creek, Yukon Territory), and one coastal site (Russell Creek, British Columbia). The results demonstrate substantially improved simulation of subcanopy snow accumulation, with mean bias reduced from -26.23 to -0.63 kg m⁻² and RMSE reduced from 110.61 to 44.70 kg m⁻² across the four sites. Simulations of canopy snow load also showed improved performance across sites. The improved model enabled diagnosis of how climate and vegetation types influence the processes governing snow partitioning in needleleaf canopies, which will be presented.
:::
...
1. What is the performance of a novel forest snow hydrological model in simulating the accumulation of subcanopy SWE in forested environments characterized by varying tree species, canopy structures, and meteorological conditions?
...
![Graph showing mean monthly relative humidity, air temperature, total precipitation, and wind speed over the simulation period for each station. See @tbl-site-meta for the corresponding date ranges of each site. Observations were not available during the snow free period for Russell Creek (Jun—Sept).](figs/final/figure2.png){#fig-met-normals}
...
Observations of canopy snow load were limited across the four sites, and only available at Fortress and Marmot. Evaluation of the CP25 model on snow load was presented in @Cebulski2025a and @Cebulski2025b at Fortress Mountain. At Marmot Creek, canopy snow load measurements were determined between 2007–2008 for 11 individual snowfall events based on the availability of data from @MacDonald2010. Between 2018–2019 15-minute interval measurements of canopy snow load were available throughout most of the winter from @Staines2022. Over the two winter seasons at Marmot Creek, canopy snow load was overestimated by the CP25 model and underestimated by the E10 [@fig-cpy-load-ts]. The error in simulated canopy snow load over the two periods was lower for CP25 with a mean bias of `r cp25_mc_mb_L` kg m^-2^ compared to the higher error of E10 of `r e10_mc_mb_L` kg m^-2^. For smaller canopy snow loads below 10 kg m^-2^ the agreement between CP25 and E10 is generally better due to the species specific canopy holding capacity of 8.7 kg m^-2^ used by the E10 model which increases throughfall once the canopy snow load is above this threshold.

For the 2018—2019 period the fraction of the year that the canopy was loaded with >2 kg m^-2^ of snow was found to be `r cpy_load_frac_yr$Obs |> round(2)`, compared to simulations of `r cpy_load_frac_yr$CP25 |> round(2)` and `r cpy_load_frac_yr$E10 |> round(2)` by the CP25 and E10 models respectively. The underestimate of canopy snow cover duration by the E10 model of around `r cpy_load_frac_yr$percent_change_e10_obs |> round(1)`% results from overestimate of throughfall and unloading rate as a function of canopy snow load which depletes the canopy of snow earlier than the observations. The CP25 model underestimated the snow covered duration by `r cpy_load_frac_yr$percent_change_cp25_obs |> round(1)`%. Although the CP25 model generally overestimated canopy snow load, the CP25 model emptied the canopy of snow earlier than the observations during the tail end of several events. Moreover, during warmer months between may and june the CP25 model underestimated canopy snow load leading to shorter snow covered duration over these events. 
...
#| tbl-cap: "Mean bias (MB), root mean squared error (RMSE), and coefficient of determination ($r^2$) determined from time-series simulations of canopy snow load for the two models CP25 and E10 at Marmote Creek."
##| tbl-colwidths: [20, 13, 13, 13, 13, 13]
...
Both models performed best at the sites where they were originally developed or improved (CP25 at Fortress and E10 at Marmot), which aligns with observations by @Lumbrazo2022 that parameters for unloading are site specific and may suggest the initial interception parameters or model process conceptions are as well. Low error at the cold sites suggests that the dry snow unloading parameterisation is transferable across sites and is consistent with observations by @Lumbrazo2022—where a wind-driven unloading parameterisation had good accuracy across a cold-climate sites. The CP25 model performed worst at the temperate-maritime Russell site, where melt/drip and melt-induced unloading processes dominated, despite showing improvements over E10 in this study and showing strong performance over warm melt-driven events in @Cebulski2025b. Remaining error at Russell may reflect unrepresented processes, such as rime-ice accumulation observed in other maritime forests [@Lumbrazo2022], which can increase canopy loads and favours partitioning to liquid water. Additional uncertainties stem from simplifications in the canopy energy balance (e.g., radiation transmittance, longwave emission, and turbulent fluxes), as well as parameterisations of interception and unloading [@Cebulski2025a; @Cebulski2025b]. These issues are likely amplified at Russell, where frequent air temperatures near the melting point cause large changes in enthalpy which increase phase change sensitivity to energy balance formulations, compared to the colder sites with more stable enthalpy conditions.
